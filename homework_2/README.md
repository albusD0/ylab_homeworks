...
Баг при значении **-1** довольно маловероятен, и все же, никогда неизвестно наверняка, как именно программист реализовал алгоритм рассчета скидки, ошибка может закрасться не в сами числа, которые он использовал, а в знаки (>, <, =) или формулу подсчета, поэтому необходимо проверить и это значение тоже.
