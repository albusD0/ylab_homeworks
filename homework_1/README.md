...
|  2 | Автоматическое перемещение вновь созданного письма в новый раздел "Черновик", если оно не было отправлено | 1. Нажать кнопку "Создать письмо" | Открывается форма для создания письма с полями для ввода адреса, темы, тела сообщения и возможностью вложить файл. Обязательные поля должны быть помечены |    
|    |             | 2. Заполнить поля "Кому", "Тема" и тело сообщения, вложить файл |  |
|    |             | 3. Перейти в любой другой раздел |  |
