...
|    |             | 2. Заполнить поля "Кому", "Тема" и тело сообщения, вложить файл |  |
|    |             | 3. На выбор: Нажать на кнопку "Сохранить как черовик" либо перейти в любой другой раздел, кроме "Черновика" | Выводится сообщение, что письмо сохранено как черновик в соответствующем разделе для дальнейшей работы |
