...
- 1. безопасность, где помимо теста на защиту от вредоносных приложений можно проверить
     - шифрование
     - защиту паролем
2. надежность, куда можно включить проверку работы приложения при сбоях, медленном или слабом соединении Интернета, возможность восстановления случайно удаленных или утраченных при сбое писем
2. производительность:
  - скорость обработки большого числа писем в папках
  - скорость поиска по папкам с большим числом писем в разделах прочие.
4. удобство использования, интерфейс (UX/UI)
