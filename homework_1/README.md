...
|    |             | 4. Перейти в раздел "Отправленные" | В разделе "Отправленные" находится только что отправленное нами письмо, оно корректно открывается и доступно для редактирования, пересылки и прочих стандартных манипуляций, предусмотренных приложением |
...
| |  | 2. Нажать кнопку "Удалить письмо" | |
| |  | 3. Перейти в раздел "Удаленные" | В разделе "Удаленные" находится только что удаленное нами письмо, оно  корректно открывается и доступно для редактирования, пересылки и прочих стандартных манипуляций, предусмотренных приложением |




1. Нажать кнопку "Создать письмо" | Открывается форма для создания письма с полями для ввода адреса, темы, тела сообщения и возможностью вложить файл. Обязательные поля должны быть помечены |    
|    |             | 2. Заполнить поля "Кому", "Тема" и тело сообщения, вложить файл |  |
|    |             | 3. Нажать кнопку "Отправить письмо" | Письмо успешно отправляется вместе с вложенным файлом, если обязательные поля не заполнены - выдать предупреждение |

|    |             | 4. Перейти в раздел "Отправленные" | В разделе "Отправленные" находится только что отправленное нами письмо, корректно открывается и доступно для редактирования, пересылки и прочих стандартных манипуляций, предусмотренных приложением |
