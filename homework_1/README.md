...
|  2 | Перемещение письма в раздел "Удаленные" после удаления письма. | 1. Выбрать любое письмо в разделе по выбору ("Входящие" / "Отправленные") | 
...
| | *Предусловие: имеются письма в одном из разделов "Входящие" или "Отправленные". При отсутствии отправить на текущий тестовый адрес письмо либо создать по следующей схеме:  1. Нажать кнопку "Создать письмо".* *2. Заполнить поля "Кому", "Тема" и тело сообщения.* *3. Нажать кнопку "Отправить письмо"*| 2. Нажать кнопку "Удалить письмо" | Письмо успешно удаляется, при этом выдается сообщение, действительно ли пользователь собирается удалить его |
| |  | 3. Перейти в раздел "Удаленные" | В разделе "Удаленные" находится только что удаленное нами письмо, оно  корректно открывается и доступно для редактирования, пересылки, окончательного удаления и прочих стандартных манипуляций, предусмотренных приложением для текущего раздела |
| |  | 3. Перейти в раздел "Отправленные" | Убедиться, что в разделе "Отправленные" нет копии удаленного письма |
